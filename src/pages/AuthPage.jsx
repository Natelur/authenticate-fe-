...
export default function AuthPage() {
  ...
  const url =
    "https://cf0eaa5a-459d-402e-bcdb-93aa7f862ee5-00-19exkd3idx66v.pike.replit.dev";
  ...
  return (
    <Row>
      ...
      <Col sm={6} className="p-4">
        ...
        <p className="my-5" style={{ fontSize: 31 }}>
          Join Twitter Today
        </p>
        <Col sm={5} className="d-grid gap-2">
          ...
          <Button className="mt-5rounded-pill" onClick={handleShowSignUp}>
            Create an account
          </Button>
